...
{
    public partial class JigsSelector2 : Form
    {
        public JigsSelector2()
        {
            InitializeComponent();
        }
        ...
        private void JigsSelector2_Load(object sender, EventArgs e)
        {
            ...
            string sql = "Delete from JIGLIST Where JIGNUMBER = '2'";
        ...
        private void buttonJig1_Click(object sender, EventArgs e)
        {
...

            {
                try
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(sql, connection))
                    {
                        cmd.Parameters.AddWithValue("@Jignumber", "2");
