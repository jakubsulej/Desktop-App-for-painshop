...
{
    public partial class JigsSelector3 : Form
    {
        public JigsSelector3()
        {
            InitializeComponent();
        }
        ...
        private void JigsSelector3_Load(object sender, EventArgs e)
        {
            ...
            string sql = "Delete from JIGLIST Where JIGNUMBER = '3'";
        ...
        private void buttonJig1_Click(object sender, EventArgs e)
        {
...

            {
                try
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(sql, connection))
                    {
                        cmd.Parameters.AddWithValue("@Jignumber", "3");
