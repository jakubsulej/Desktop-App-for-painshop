...
using PaintshopAppUI.Views.CoatViews;
...
namespace PaintshopAppUI.Views
{
    public partial class MainForm : Form
    {
        ...
        private void buttonCoatC_Click(object sender, EventArgs e)
        {
            CoatCCount1.Show();
            CoatD1.Hide();
            CoatACount.Hide();
        ...
        private void buttonCoatD_Click(object sender, EventArgs e)
        {
            CoatD1.Show();
            CoatCCount1.Hide();
            CoatACount.Hide();
        ...
        private void buttonCoatCQuantity_MouseHover(object sender, EventArgs e)
        {
            panel2.BackColor = Color.FromArgb(255, 255, 255);
            panel3.BackColor = Color.FromArgb(255, 255, 255);
        ...
        private void buttonCoatD_MouseHover(object sender, EventArgs e)
        {
            panel2.BackColor = Color.FromArgb(255, 255, 255);
            panel3.BackColor = Color.FromArgb(255, 255, 255);
            panel5.BackColor = Color.FromArgb(255, 255, 255);
